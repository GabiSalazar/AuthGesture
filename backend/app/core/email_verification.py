...
class EmailVerificationSystem:
    ...
    def _build_verification_email_html(self, username: str, verification_code: str, expiry_minutes: int) -> str:
        """Construye HTML del email con código de verificación"""
        ...
        <body>
            <div class="email-container">
                ...
                <div class="content">
                    ...
                    <p class="message">
                        Para completar tu registro en Auth-Gesture, ingresa el siguiente código de verificación en la aplicación:
                    </p>
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-box-text">
                            Este código es válido por {expiry_minutes} minutos. No compartas este código con nadie.
                        </div>
                    </div>
